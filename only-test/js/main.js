...
$('.js-header').each(function (index, element) {
  var $component = $(element);
  var $showMenuButton = $component.find('.js-menu-button');
  var $mainMenu = $(document.body).find('.js-main-menu');
  var menuToggleBool = false;
  $(window).on('scroll', function () {
    $component.toggleClass('small', pageYOffset > 0);
  });
  $showMenuButton.on('click', function (e) {
    if (menuToggleBool) {
      $(e.target).stop(true, true).removeClass('active');
      $mainMenu.stop(true, true).trigger('menu:hide');
    } else {
      $(e.target).stop(true, true).addClass('active');
      $mainMenu.stop(true, true).trigger('menu:show');
    }
...
$('.js-main-menu').each(function (index, element) {
  var $component = $(element);
  var menuTimeout;
  var scrollTopOffset = 0;
  $component.on('menu:show', function (e) {
    if (menuTimeout) {
...
/* harmony import */ var _components_main_menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_main_menu__WEBPACK_IMPORTED_MODULE_2__);
