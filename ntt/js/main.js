...
/***/ "./src/js/components/header-menu/header-menu.js":
/*!******************************************************!*\
  !*** ./src/js/components/header-menu/header-menu.js ***!
  \******************************************************/
...
$('.header-menu').each(function (index, component) {
  var $component = $(component);
  $(window).on('menu:show', function () {
    $component.stop(true, true).addClass('active');
  });
  $(window).on('menu:hide', function () {
...
$('.header').each(function (index, component) {
  var $component = $(component);
  var $button = $component.find('.js-button');
  var menuShown = false;
  ...
  $(window).on('menu:show', function () {
    $component.stop(true, true).addClass('show-menu');
    $button.stop(true, true).addClass('active');
  });
  $(window).on('menu:hide', function () {
    $component.stop(true, true).removeClass('show-menu');
    $button.stop(true, true).removeClass('active');
  });
  $button.on('click', function (e) {
    ...
    if (menuShown) {
      $(window).trigger('menu:show');
    } else {
      $(window).trigger('menu:hide');
    }
  });
});
...
/* harmony import */ var _components_header_menu_header_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/header-menu/header-menu */ "./src/js/components/header-menu/header-menu.js");
